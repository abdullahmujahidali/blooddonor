...
public class FindBloodTestCenters extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        ib.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				...
				Intent i=new Intent(FindBloodTestCenters.this,MakeANote.class);
				startActivity(i);
			}
        ...
        l.setOnItemClickListener(new OnItemClickListener(){
			...
			public void onItemClick(AdapterView<?> parent, View view, int position,
				...
				Intent i =new Intent(FindBloodTestCenters.this,FindBloodTestList.class);
				i.putExtra("city", s1);
				startActivity(i);
				// TODO Auto-generated method stub
	    ...
	    //l.setAdapter(adapter);
			...
			public void onTextChanged(CharSequence s, int start, int before,
					int count) {
				FindBloodTestCenters.this.adapter.getFilter().filter(s);
				// TODO Auto-generated method stub
