...
public class FindByCityArray extends ArrayAdapter<String> {
	View cview;
    TextView tv1,tv2;
    Context con;
   ArrayList<String> x,y;

	public FindByCityArray(Context context,ArrayList<String>arr) {
		super(context, R.layout.findbycityarray,arr);
		con=context;
		x=arr;
	...
	public View getView(int position,View convertView,ViewGroup parent){
		...
		cview=inflator.inflate(R.layout.findbycityarray, null);
